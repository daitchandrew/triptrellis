...
export const fallbackCityGuides = {
  ...
  "paris": buildGuide({
    ...
    food: [
      ...
      food("Le Chateaubriand", "marais", ["food"], "Contemporary bistro", "A stronger destination dinner if the trip wants another current Paris table beyond the obvious classics."),
  ...
  "barcelona": buildGuide({
    ...
    food: [
      ...
      food("Gresca", "eixample", ["food"], "Current bistro", "A smart Eixample dinner if the trip wants something more current than classical tapas rooms."),
    ],
  }),
  "venice": buildGuide({
    label: "Venice",
  ...
  "amsterdam": buildGuide({
    ...
    food: [
      ...
      food("Café Restaurant Amsterdam", "canal-belt", ["food"], "Dutch-European brasserie", "A stronger larger-room dinner if the trip wants one more classic polished Amsterdam meal."),
...
export const fallbackCitySupplements = {
  "singapore": [
    sight("Jewel Changi Rain Vortex", "marina-bay", ["design", "nature"], "A polished spectacle stop that works surprisingly well on an arrival or departure day."),
    activity("East Coast Park cycle and seafood block", "marina-bay", ["nature", "food"], "A breezier coastal stretch when the trip wants a less vertical side of Singapore."),
    activity("Tiong Bahru café and bookshop drift", "chinatown", ["cafes", "design", "walkability"], "A softer neighborhood add-on for mornings that should feel local and current."),
    ...
    food("Jumbo Seafood Riverside Point", "marina-bay", ["food"], "Singapore chili crab", "A classic seafood dinner when the trip wants one unmistakably local table."),
    ...
    sight("MacRitchie TreeTop Walk approach", "orchard", ["nature", "wellness"], "A greener half-day move if the trip wants one stronger nature reset."),
    activity("Katong shophouse and laksa loop", "kampong-glam", ["food", "culture", "walkability"], "A more residential food-and-architecture route beyond the central core."),
    ...
    food("Atlas afternoon tea or cocktails", "kampong-glam", ["cafes", "luxury"], "Tea and cocktails", "A softer dressed-up pause if the trip wants one glamorous room without turning the whole night formal."),
  ...
  "hong-kong": [
    sight("Wong Tai Sin Temple", "causeway-bay", ["culture"], "A vivid temple stop if the trip wants something beyond the harbor-core first-timer loop."),
    activity("Monster Building and Quarry Bay photo detour", "causeway-bay", ["design"], "A denser hyper-urban side of Hong Kong that works best as a short add-on."),
    activity("Lantau cable car and Ngong Ping option", "central", ["nature", "culture"], "A larger half-day move if the trip wants one big scenic detour."),
    food("Kam Wah Cafe", "causeway-bay", ["cafes", "food", "value"], "Hong Kong bakery and tea set", "A useful cha chaan teng breakfast or snack move."),
    ...
    sight("Nan Lian Garden", "causeway-bay", ["nature", "culture"], "A calmer landscaped contrast if the trip wants one quieter visual break."),
    activity("Sham Shui Po market-and-fabric browse", "sheung-wan", ["shopping", "culture", "food"], "A more textured neighborhood add-on when the trip wants depth over polish."),
    ...
    food("Oi Man Sang", "sheung-wan", ["food", "nightlife"], "Dai pai dong", "A lively local-feeling dinner if the night should feel grittier and more memorable."),
    sight("Tai O stilt village add-on", "central", ["culture", "nature"], "A larger excursion if the trip wants one more traditional waterside contrast to the core city."),
