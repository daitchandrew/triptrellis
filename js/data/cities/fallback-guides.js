...
export const fallbackCitySupplements = {
  ...
  "lisbon": [
    ...
    food("Dear Breakfast", "principe-real", ["cafes", "food"], "Breakfast and coffee", "A strong morning start when the trip wants one more polished daytime café."),
  ...
  "new-york": [
    ...
    food("L'Artusi", "west-village", ["food"], "Italian", "A polished Village dinner that fits naturally into a west-side night."),
    ...
    food("Superiority Burger", "lower-east-side", ["food", "value"], "Vegetarian comfort food", "A useful Lower East Side or East Village meal if the trip wants more variety."),
  ...
  "los-angeles": [
    ...
    food("Found Oyster", "silver-lake", ["food"], "Seafood", "A stronger east-side dinner if the night stays around Los Feliz or Silver Lake."),
    food("Great White", "west-hollywood", ["cafes", "food"], "All-day café", "A good lower-friction daytime stop when the west side plan needs a polished reset."),
  ...
  "mexico-city": [
    ...
    food("Expendio de Maíz", "roma-norte", ["food"], "Maize-forward Mexican cooking", "A stronger local-feeling meal for a food-forward Roma Norte day."),
    food("Rosetta", "roma-norte", ["food", "luxury"], "Italian-Mexican bakery and dining room", "A polished city classic if the trip wants one harder-to-book table.", "Reserve ahead."),
    food("El Vilsito", "roma-norte", ["food", "value", "nightlife"], "Late-night tacos", "A useful high-energy taco stop if the night runs later."),
    sight("Biblioteca Vasconcelos", "roma-norte", ["design", "culture"], "A striking library stop if the trip wants one more contemporary architectural highlight."),
