...
export const expandedSupplements = {
  "new-york": [
    {
      ...
      "name": "McNally Jackson and Nolita browse",
      "area": "soho",
      "description": "A softer downtown block of bookstores, side streets, and coffee if the day wants texture over landmarks."
    },
    {
      "categoryLabel": "Food",
    ...
    },
    {
      ...
      "area": "midtown",
      "description": "A beautiful smaller museum if the trip wants one more literary and architectural interior in Midtown."
    },
    {
      "categoryLabel": "Place to Wander",
    ...
    },
    {
      ...
      "name": "Semma",
      "area": "west-village",
      "description": "A standout West Village reservation if the trip wants one sharply specific, regionally focused Indian dinner.",
      "michelinStatus": "One Star",
      "guideNote": "Michelin highlights its deeply rooted regional South Indian cooking and confident use of spice.",
      "guideUrl": "https://guide.michelin.com/gb/en/new-york-state/new-york/restaurant/semma"
    },
    {
      "categoryLabel": "Food",
      "name": "Los Tacos No. 1",
      "area": "midtown",
      "description": "A reliable fast-moving stop for an easy, satisfying Midtown lunch without wasting the day on a sit-down meal."
    },
    {
      "categoryLabel": "Museum",
      "name": "The Frick Collection",
      "area": "midtown",
      "description": "A more intimate museum stop if the trip wants elegance and scale rather than another giant institution."
    },
    {
      "categoryLabel": "Place to Wander",
    ...
    },
    {
      ...
      "name": "Dame",
      "area": "lower-east-side",
      "description": "A sharp smaller seafood-led downtown reservation if the trip wants another current New York dinner with character."
    }
  ],
  "los-angeles": [
    {
    ...
    },
    {
      ...
      "area": "downtown-la",
      "description": "A classic LA lunch stop that gives the city one more old-school institution beyond trendier neighborhoods."
    },
    {
    ...
    },
    {
      ...
      "name": "Found Oyster",
      "area": "west-hollywood",
      "description": "A lively seafood-led dinner if the night should stay central and distinctly LA."
    },
    {
      "categoryLabel": "Place to Wander",
  ...
  "mexico-city": [
    ...
    },
    {
      ...
      "name": "El Moro Centro",
      "area": "centro",
      "description": "A classic stop for churros and chocolate if the Centro day needs one more iconic sweet break."
    },
    {
      "categoryLabel": "Food",
      "name": "Contramar",
    ...
    {
      "categoryLabel": "Nature",
      "name": "Parque España pause",
      "area": "condesa",
      "description": "A softer neighborhood reset if the Roma-Condesa part of the trip wants more breathing room."
    },
    {
      "categoryLabel": "Museum",
  ...
  "buenos-aires": [
    ...
    },
    {
      ...
      "name": "Café Tortoni",
      "area": "san-telmo",
      "description": "Worth doing once if the trip wants a classic Buenos Aires coffee-room moment."
    },
    {
      "categoryLabel": "Nature",
    ...
    },
    {
      ...
      "name": "Tres Monos cocktails",
      "area": "palermo",
      "description": "A lively cocktail stop if the Palermo night should feel current and a bit more design-forward."
    },
    {
      "categoryLabel": "Food",
    ...
    },
    {
      ...
      "area": "recoleta",
      "description": "A theatrical bookstore stop that deepens the Recoleta side of the trip without adding too much weight."
    },
    {
      "categoryLabel": "Place to Wander",
    ...
    },
    {
      ...
      "name": "Niño Gordo",
      "area": "palermo",
      "description": "A lively Palermo dinner if the trip wants one louder, more contemporary restaurant with style."
    }
  ]
};
